...
tst_dir <- "/home/ehenrich/R/Gen_Test"
```
...
ge67_tst_from <- paste0(ge_dir,"/SDY67-batch2.GEMatrix.txt")
ge67_tst_to <- paste0(tst_dir,"/SDY67-batch2.GEMatrix.txt")
file.copy(ge67_tst_from, ge67_tst_to)
...
rds67_tst_from <- paste0(rds_dir,"/SDY67-batch2.rds")
rds67_tst_to <- paste0(tst_dir,"/SDY67-batch2.rds")
file.copy(rds67_tst_from, rds67_tst_to)
```
