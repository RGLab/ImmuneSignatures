...
#### Discovery Group Significant Pathways  
``` {r}
DT::datatable(yng_res_dfs$dsc)
```

#### Validation Study Significant Pathways  
``` {r}
...
#### FIGURES
```{r results="markup", fig.height=7, fig.width=7}
...
*possible and expected values in [brackets]*  
