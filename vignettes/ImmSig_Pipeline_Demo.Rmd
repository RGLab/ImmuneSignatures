...
agePlot <- ggplot(data = pd, aes(x = Study))                      + 
...
#### Figure 4
Forest plot of up and down regulation of significant genes from the discovery studies. Code developed by F. Vallenia @ Stanford.
...
#### Figure 6 - Validation SDY80 Response 
...
Figure 8A compares p-values of each gene in older and younger cohorts, while figure 8B does the same for pathway-activity of the gene set modules.  Each gene or pathway is coded into non-significant (grey circle), significant-upregulated (black square), or significant-downregulated (black triangle). 
